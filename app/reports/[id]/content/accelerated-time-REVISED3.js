  ...
  return (
    <>
        ...
        <nav className="ml-6 space-y-2 text-sm">
          ...
          <div>
            ...
            <ul className="ml-6 mt-1 space-y-1">
              ...
              <li><a href="#electromagnetic-correspondence" onClick={(e) => scrollToSection(e, 'electromagnetic-correspondence')} className="text-[#3B82C8] dark:text-[#60A5FA] hover:underline cursor-pointer">Electromagnetic Radiation Correspondence</a></li>
      ...
      <section className="mb-12">
        ...
        <h3 id="electromagnetic-correspondence" className="text-2xl font-semibold mt-8 mb-4">Electromagnetic Radiation Correspondence</h3>
        <p>
          Section 4 presented two hypotheses for image formation: gamma ray emission as electrons dropped
          energy levels (primary), or modulated UV emission (alternative). Recent laser experiments demonstrate
          that brief, intense electromagnetic radiation can produce Shroud-like oxidation characteristics.
        </p>
        <p className="mt-4">
          Di Lazzaro and colleagues at ENEA achieved breakthrough replication using vacuum ultraviolet radiation:
        </p>
        <ul className="list-disc ml-8 space-y-2 mt-4 pl-5">
          <li>ArF excimer laser at 193-nanometer wavelength</li>
          <li>Produced 0.2 micrometer coloration depth matching the Shroud precisely</li>
          <li>Created yellow-sepia hue identical to Shroud coloration</li>
          <li>Limited effects on primary cell wall, leaving fiber medulla unaffected</li>
          <li>Required 34 trillion watts for 12 nanoseconds (Di Lazzaro et al. 2010<sup>ᵖ</sup>)</li>
        </ul>
        <p className="mt-4">
          The researchers concluded: "The total radiation power required to color a linen surface corresponding
          to a human body makes impossible the reproduction of the Turin Shroud image by using a single laser"
          —impossible for human technology, but trivial for beings managing complete matter-energy conversion.
        </p>
        <p className="mt-4">
          This experimental result demonstrates that brief electromagnetic emission can produce the documented
          oxidation pattern. Whether through direct UV emission (alternative hypothesis) or through gamma-induced
          secondary fluorescence producing UV (primary hypothesis), the 12-nanosecond pulse required only
          400 kilojoules—0.0000000000065% of the energy available from dissolution. The Master Physical Controllers'
          ability to modulate electron transitions, described in Section 4, provides the mechanism for such
          precisely calibrated emission.
        </p>
        ...
        <p>
          During the brief electromagnetic emission phase (approximately 12 nanoseconds), the suspended configuration
          enabled:
        </p>
        <ul className="list-disc ml-8 space-y-2 mt-4 pl-5">
