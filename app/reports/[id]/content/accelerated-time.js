...
const scrollToSection = (e, sectionId) => {
  ...
  // Header height calculation for desktop:
  // - Main header: 57px
  // - Report title + TTS controls: ~75px
  // - Additional buffer for TTS reading cursor: ~20px
  // Total: ~152px
    ...
    <>
      ...
      <section className="mb-12">
        ...
        <p>
          ...
          energy states—from the body's electronic stage of matter through visible light,
          ultraviolet radiation, x-rays, and beyond, ultimately achieving complete
        ...
        <p>
          ...
          transforming body became a source of UV light.
        </p>
        <p>
          This was not an accident of overwhelming energy, but a conscious act of
          documentation. The temporal void contained energies that would otherwise cause
          planetary devastation—complete matter-energy conversion of a 70-kilogram mass
          yields approximately 6.3×10²⁰ joules, equivalent to 1.5 billion megatons TNT<sup>ᵇ</sup>. Yet
          only 400 kilojoules escaped during that brief UV pulse, precisely calibrated to
          oxidize the surface fibers of linen to a depth of 200 nanometers without
          overexposing the image formation.
        </p>
        <p>
